...
exports.createMintCommand = createMintCommand;
exports.runMint = runMint;
...
// Command Definition
// ============================================================================
function createMintCommand() {
    const cmd = new commander_1.Command('mint')
...
// Implementation
// ============================================================================
async function runMint(address, amount, output) {
    // Check we're in mock mode
    const config = (0, config_1.loadConfig)();
    if (config.mode !== 'mock') {
        throw new Error('Mint command only available in mock mode.\n' +
    ...
    const amountWei = Math.floor(amountNum * 1000000).toString();
