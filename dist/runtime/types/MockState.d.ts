 ...
 */
export type TransactionState = 'INITIATED' | 'QUOTED' | 'COMMITTED' | 'IN_PROGRESS' | 'DELIVERED' | 'SETTLED' | 'DISPUTED' | 'CANCELLED';
/**
 * Numeric state values matching the smart contract enum.
 */
export declare const TransactionStateValue: Record<TransactionState, number>;
/**
...
export declare const MOCK_STATE_DEFAULTS: {
    ...
    readonly DEFAULT_USDC_BALANCE: "10000000000";
};
